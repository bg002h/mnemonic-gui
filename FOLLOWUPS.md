...
- **Status:** `open` (usability; per the standing "usability is a first-class bar"). **Tier:** `ux`. **Companion:** `gui-automated-ui-functionality-harness` (the harness that found it).
